...
// Pipeline Definition for Python Units and Libraries
	...
	pipeline {
		...
		parameters {
	    	...
	    	string(name: 'NEX_DEV_VERSION', defaultValue: '', description: 'Next development version (e.g: 1.2.0.dev1) according to <a href="https://www.python.org/dev/peps/pep-0440/">PEP-440</a>')
		}
